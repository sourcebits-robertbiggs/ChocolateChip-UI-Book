...
```
<nav class="next">
	<a class="button back" href="#">Fruits</a>
	<h1 id="fruitTitle"></h1>
</nav>
...
<article class="current" id="apples">
 ...
 <div class="tabbar" id="fruitTabbar">
  <a class="button apple"><span class="icon"></span><label>Apples</label></a>
  <a class="button orange"><span class="icon"></span><label>Oranges</label></a>
  <a class="button banana"><span class="icon"></span><label>Bananas</label></a>
  <a class="button mango"><span class="icon"></span><label>Mangos</label></a>
  <a class="button avocado"><span class="icon"></span><label>Avocados</label></a>
 </div>
